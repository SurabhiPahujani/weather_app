...
export default class ForecastTiles extends Component {
  ...
  // Filters the data by date and returns an Object containing a list of  forecast.
  _groupByDays = data => {
  ...
  render() {
    ...
    // this ensures that we are showing only s of forecast.
    const forecastTiles = tiles.length > 10 ? tiles.slice(0, 10) : tiles;
